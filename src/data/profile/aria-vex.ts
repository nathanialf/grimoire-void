...
export const ariaVex: ProfileTemplate = {
  ...
  meta: [
    { label: 'Department', value: 'Sector 9 · Deep Reconnaissance' },
    { label: 'Site', value: 'Sector 9 Forward Station · Bay 4' },
  ],
  name: 'Aria Vex',
  ...
  serviceRecord: [
    ...
    { date: 'Cycle 4420', entry: 'Promoted to Class II. Issued [[Spectral Caul|/artifact/spectral-caul]].' },
  ...
  dossier: [
    ...
    },
    {
      ...
      rows: [
        ['[[Spectral Caul|/artifact/spectral-caul]]', 'Modified psi-shielding headpiece. Dampens Class III void emanations.'],
